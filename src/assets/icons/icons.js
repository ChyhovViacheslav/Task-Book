...
export const IconSelector = ({id}) => {
    switch (id) {
        ...
        case 'trash' :
            return (
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.6875 4.5C1.6875 4.18934 1.93934 3.9375 2.25 3.9375H15.75C16.0607 3.9375 16.3125 4.18934 16.3125 4.5C16.3125 4.81066 16.0607 5.0625 15.75 5.0625H2.25C1.93934 5.0625 1.6875 4.81066 1.6875 4.5Z" fill="#F05454"/>
        ...
        case 'triangle' : 
            return (
                <svg fill='#F05454' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
